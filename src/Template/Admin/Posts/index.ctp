    ...
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('Voir'), ['action' => 'view', $post->id]) ?>
                    <?= $this->Html->link(__('Modifier'), ['action' => 'edit', $post->id]) ?>
                    <?= $this->Form->postLink(__('Supprimer'), ['action' => 'delete', $post->id], ['confirm' => __('Are you sure you want to delete # {0}?', $post->id)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
